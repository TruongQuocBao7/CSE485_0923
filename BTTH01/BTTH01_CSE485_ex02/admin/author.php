...
<body class="mx-5">
    ...
    <div class="m-5">
        <div class="mx-5">
            <div class="mx-5">
                <a href="http://localhost/BTTH01_CSE485_ex02/admin/add_author.php?admin=true">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="fs-4 color-primary" href="http://localhost/BTTH01_CSE485_ex02/admin/edit_author.php?admin=true&id=<?php echo $tgia['ma_tgia']; ?>">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="http://localhost/BTTH01_CSE485_ex02/post/post_delete_author.php?admin=true&id=<?php echo $tgia['ma_tgia']; ?>"><button type="button" class="btn btn-primary">Yes</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
