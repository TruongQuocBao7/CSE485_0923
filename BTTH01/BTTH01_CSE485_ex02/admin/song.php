...
<body class="mx-5">
    ...
    <div class="m-5">
        <a href="http://localhost/BTTH01_CSE485_ex02/admin/add_song.php?admin=true">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="fs-4 color-primary" href="http://localhost/BTTH01_CSE485_ex02/admin/edit_song.php?admin=true&id=<?php echo $baiviet['ma_bviet']; ?>">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="http://localhost/BTTH01_CSE485_ex02/post/post_delete_song.php?admin=true&id=<?php echo $baiviet['ma_bviet'];?>"><button type="button" class="btn btn-primary">Yes</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
